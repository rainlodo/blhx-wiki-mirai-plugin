...
object DrawUtils {
    ...
    private fun initIcon() {
        ...
        ship_contain_map[Pair(DrawType.Light, Rarity.SSR)] = listOf(
            "能代", "风云", "圣地亚哥", "圣地亚哥", "圣地亚哥", "圣地亚哥", "圣地亚哥", "蒙彼利埃", "黛朵", "确捷", "雪风", "明石", "Z46", "阿芙乐尔", "凯旋", "恶毒", "江风", "艾伦·萨姆纳", "塔什干(μ兵装)", "黛朵(μ兵装)"
        )
        ship_contain_map[Pair(DrawType.Light, Rarity.SR)] = listOf(
            "白雪", "霞", "伯明翰", "史蒂芬·波特", "佩内洛珀", "肇和", "应瑞", "莫里", "马拉尼", "拉菲", "圣路易斯", "小海伦娜", "丹佛", "小克利夫兰", "比洛克西", "克利夫兰(μ兵装)", "标枪", "无敌", "欧若拉", "谢菲尔德", "格罗斯特", "小贝法", "黑太子", "吹雪", "绫波", "野分", "最上", "三隈", "Z23", "Z25", "Z35", "长春", "太原", "逸仙", "宁海", "平海", "鲁莽", "倔强", "春月", "宵月", "花月", "长波"
        )
        ...
        ship_contain_map[Pair(DrawType.Heavy, Rarity.SR)] = listOf(
            "休斯敦", "印第安纳波利斯", "亚利桑那", "科罗拉多", "马里兰", "伦敦", "多塞特郡", "约克", "足柄", "声望", "伊丽莎白女王", "纳尔逊", "黑暗界", "恐怖", "阿贝克隆比", "雾岛", "德意志", "斯佩伯爵海军上将", "希佩尔海军上将", "希佩尔海军上将(μ兵装)", "小比叡", "敦刻尔克", "铃谷", "比叡", "朱利奥·凯撒", "巴尔的摩(μ兵装)"
        )
        ...
        ship_contain_map[Pair(DrawType.Special, Rarity.SR)] = listOf(
            "休斯敦", "印第安纳波利斯", "列克星敦", "萨拉托加", "约克城", "大黄蜂", "鲦鱼", "女灶神", "伦敦", "多塞特郡", "独角兽", "追赶者", "光荣", "伊26", "伊58", "U-557", "小赤城", "小齐柏林", "絮库夫", "伊25", "U-522", "伊56", "U-556", "U-73", "U-110", "大青花鱼(μ兵装)"
        )
